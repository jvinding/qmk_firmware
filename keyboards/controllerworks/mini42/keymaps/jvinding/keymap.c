...
[JV_QWERTY] = LAYOUT_MINI42(
  JV_NP, JV_QWERTY_ROW0_L,   JV_QWERTY_ROW0_R,   JV_NP,
  JV_NP, JV_QWERTY_ROW1_L,   JV_QWERTY_ROW1_R,   JV_NP,
  JV_NP, JV_QWERTY_ROW2_L,   JV_QWERTY_ROW2_R,   JV_NP,
         JV_QWERTY_THUMBS_L, JV_QWERTY_THUMBS_R
),

[JV_WINDOWS] = LAYOUT_MINI42(
  JV_NP, JV_WINDOWS_ROW0_L,   JV_WINDOWS_ROW0_R,   JV_NP,
  JV_NP, JV_WINDOWS_ROW1_L,   JV_WINDOWS_ROW1_R,   JV_NP,
  JV_NP, JV_WINDOWS_ROW2_L,   JV_WINDOWS_ROW2_R,   JV_NP,
         JV_WINDOWS_THUMBS_L, JV_WINDOWS_THUMBS_R
),
