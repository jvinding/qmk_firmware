...
[JV_NAV] = LAYOUT_split_3x5_3(
  KC_PGUP,            KC_HOME,        KC_UP,          KC_END,         KC_INS,         JV_NA,          TD(JV_TD_BASE), TD(JV_TD_EXTRA),TD(JV_TD_TAP),  TD(JV_TD_BOOT),
...
[JV_MOUSE] = LAYOUT_split_3x5_3(
  MS_WHLU,            MS_WHLL,        MS_UP,          MS_WHLR,        JV_NU,          JV_NA,          TD(JV_TD_BASE), TD(JV_TD_EXTRA),TD(JV_TD_TAP),  TD(JV_TD_BOOT),
...
[JV_MEDIA] = LAYOUT_split_3x5_3(
  UG_HUEU,            UG_SATU,        KC_VOLU,        UG_VALU,        UG_TOGG,        JV_NA,          TD(JV_TD_BASE), TD(JV_TD_EXTRA),TD(JV_TD_TAP),  TD(JV_TD_BOOT),
...
[JV_NUM] = LAYOUT_split_3x5_3(
  TD(JV_TD_BOOT),     TD(JV_TD_TAP),  TD(JV_TD_EXTRA),TD(JV_TD_BASE), MO(JV_NUMPAD),  KC_LBRC,        KC_7,           KC_8,           KC_9,           KC_RBRC,
...
[JV_NUMPAD] = LAYOUT_split_3x5_3(
  TD(JV_TD_BOOT),     TD(JV_TD_TAP),  TD(JV_TD_EXTRA),TD(JV_TD_BASE), JV_NA,          KC_KP_SLASH,    KC_KP_7,        KC_KP_8,        KC_KP_9,        KC_KP_MINUS,
...
[JV_SYM] = LAYOUT_split_3x5_3(
  TD(JV_TD_BOOT),     TD(JV_TD_TAP),  TD(JV_TD_EXTRA),TD(JV_TD_BASE), JV_NA,          KC_LCBR,        KC_AMPR,        KC_ASTR,        KC_LPRN,        KC_RCBR,
...
[JV_FUN] = LAYOUT_split_3x5_3(
  TD(JV_TD_BOOT),     TD(JV_TD_TAP),  TD(JV_TD_EXTRA),TD(JV_TD_BASE), JV_NA,          KC_PSCR,        KC_F7,          KC_F8,          KC_F9,          KC_F12,
