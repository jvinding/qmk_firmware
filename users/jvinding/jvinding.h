...
// QWERTY (ColemakDH)
#define JV_QWERTY_ROW0_L  KC_Q,                   KC_W,             KC_E,             KC_R,             KC_T
#define JV_QWERTY_ROW0_R  KC_Y,                   KC_U,             KC_I,             KC_O,             KC_P
#define JV_QWERTY_ROW1_L  LCTL_T(KC_A),           LALT_T(KC_S),     LGUI_T(KC_D),     LSFT_T(KC_F),     HYPR_T(KC_G)
#define JV_QWERTY_ROW1_R  HYPR_T(KC_H),           RSFT_T(KC_J),     RGUI_T(KC_K),     RALT_T(KC_L),     RCTL_T(KC_QUOT)
#define JV_QWERTY_ROW2_L  LT(JV_BUTTON,KC_Z),     KC_X,             KC_C,             KC_V,             KC_B
#define JV_QWERTY_ROW2_R  KC_N,                   KC_M,             KC_COMM,          KC_DOT,           LT(JV_BUTTON,KC_SLSH)
...
#define JV_BUTTON_ROW1_L  KC_LGUI,  KC_LALT,  KC_LCTL,  KC_LSFT,  KC_HYPR
#define JV_BUTTON_ROW1_R  KC_HYPR,  KC_LSFT,  KC_LCTL,  KC_LALT,  KC_LGUI
